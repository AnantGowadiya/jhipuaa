...
```
$ kubectl get svc gateway -n marvel
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n marvel
```

and explore the details using

```
$ kubectl get svc exposed-registry -n marvel
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n marvel
```
